        ...
        <footer className="flex flex-wrap items-center justify-between p-3 m-auto">
          <div className="container mx-auto flex flex-col flex-wrap items-center justify-between">
            <ul className="flex mx-auto text-white text-center">
              <Link to="/terms" className="p-2 cursor-pointer hover:underline">
                Terms & Conditions
              </Link>
              <Link to='/privacy' className="p-2 cursor-pointer hover:underline">Privacy</Link>
              <Link to="/coocies" className="p-2 cursor-pointer hover:underline">Cookies</Link>
            </ul>
            <ul className="flex mx-auto text-white text-center">
              <a href='https://www.facebook.com/Your-Flipkart-page-100966205792278' className="p-2 cursor-pointer">
                <svg
