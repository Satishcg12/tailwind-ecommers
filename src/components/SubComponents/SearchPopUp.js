...
const SearchPopUp = () => {
  ...
  return (
    <>
      ...
      <div className="absolute inset-0 bg-[#0000007a] flex  flex-col items-center justify-center z-20 scale-0 " id='searchField' >
        
        <div className="bg-white w-11/12 sm:w-10/12 md:w-9/12 h-5/6 rounded-lg text-gray-800 duration-300 scale-0" id='searchField1'>
          <div className="flex justify-between m-3 px-2 items-center">
            <div className="w-10/12 m-1 shadow-lg border rounded-full overflow-hidden">
              <input
                ...
                name="search"
                id="search"
                className="w-10/12 px-10  outline-none"
              />
              <button className="bg-blue-500 text-white w-2/12 h-full py-2">
                Search
              </button>
            </div>
            ...
            <div className=" flex justify-center">
                <table className="table-auto border-separate  w-11/12 ">
                    ...
                    <tr className="text-center">
                            ...
                            <td className="">$100</td>
                            <td className=""><span className="bg-green-500 hover:bg-green-800 text-white px-2 py-1 rounded-full shadow-md"><i class="fas fa-plus-circle"></i></span></td>
                            <td className=""><span className="bg-blue-500 hover:bg-blue-800 text-white px-2 py-1 rounded-full shadow-md"><i class="fas fa-info-circle"></i></span></td>
                        </tr>
                        <tr className="text-center">
                            <td className="">item 1</td>
                            <td className=""> <img src="" alt="imgs" className="w-auto h-24 border"/></td>
